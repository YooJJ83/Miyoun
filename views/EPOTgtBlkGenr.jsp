...
<script type="text/javascript">
	...
	$( function() {
		...
		$("#jqgrid").jqGrid({
			datatype : "json",
			mtype : "post",
			colNames : [ '','학년도','업무구분','대상건수','생성건수'],
			colModel : [
				{name : 'flag',	    index : 'flag',     align : 'center', editable : false,  hidden : true},				
				{name :	'yosa',     index : 'yosa',     align : 'center', editable : false,  width:  180},
				{name : 'bzDc', index : 'bzDc', align : 'center', editable : false,  width:  170, formatter : 'select', edittype : 'select',	
					editoptions : { value : {'1':'계획입력','2':'실적입력'}}
				},
				{name : 'tgtCnt',  	index : 'tgtCnt',	align : 'center', editable : false,  width:  180},
				{name : 'genrCnt', 	index : 'genrCnt',	align : 'center', editable : false,  width:  180}
			],
		...
		<div id="container">			
			<div class="ui-section">
				<div class="ui-section-header">
					<h2 class="title">대상자 일괄 생성</h2>
					<ul class="action">
						<li>
							<span class="button"><input type="image" id="btn_genr" name="btn_genr" alt="생성" title="생성" src="/images/core/btn/btn-genr.gif" /></span>
						</li>						
					</ul>					
				</div>				
